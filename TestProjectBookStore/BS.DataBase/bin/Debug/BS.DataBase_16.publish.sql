...
GO
PRINT N'Altering [dbo].[USPAuthorDelete]...';


GO
ALTER PROCEDURE [dbo].[USPAuthorDelete]
    @AuthorId int
AS
   DELETE 
   FROM BookAuthor
   ...
   WHERE Id = @AuthorId
GO
PRINT N'Altering [dbo].[USPAuthorInsert]...';


GO
ALTER PROCEDURE [dbo].[USPAuthorInsert]
